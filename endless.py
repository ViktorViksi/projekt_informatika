...
class Pirat():
    def __init__(self):
        ...
        self.pirat_image=pygame.transform.scale(pygame.image.load("Slike\\likpirata.png"), (160, 160)).convert_alpha()
...
class Novcic(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.novcic_rect=self.novcic_slika.get_rect(midtop= (randint(40, 710), -50))
...
def drop_novcici():
    ...
    for objekt in objekti.sprites():
        if objekt.novcic_rect.bottom > 750:
    ...
    if aktivnost_igrice:
        ...
        for novcic in objekti.sprites():
            ...
            if sudar_sprite(novcic.novcic_rect)==True:
                ...
                if novcic.novcic_rect.bottom > 750:
                    lives-=1
                    if lives==0:
