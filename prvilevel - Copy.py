...
class Pirat():
    def __init__(self):
        ...
        self.pirat_image=pygame.transform.scale(pygame.image.load("Slike\\pirateskrilima.png"), (110, 180)).convert_alpha()
...
def specials_radnja():
    ...
    for special in specials.sprites():
        if special.specialbroj== 1:
            ...
            player.pirat_image=pygame.transform.scale(pygame.image.load("Slike\\pirateskrilima.png"), (220, 360)).convert_alpha()
        elif special.specialbroj == 4:
            player.pirat_image=pygame.transform.scale(pygame.image.load("Slike\\pirateskrilima.png"), (55, 90)).convert_alpha()
