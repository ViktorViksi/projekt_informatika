...
background= pygame.image.load("Slike\\newyorklevel.jpg").convert()
...
def specials_drop():
    if len(specials) == 0:
        ...
        if rendom == 1:
            ...
            special.novcic_slika=pygame.transform.scale(pygame.image.load("Slike\\doublespecial.png"), (30,30)).convert_alpha()
            ...
            special=Novcic()
            specials.add(special)
            special.novcic_slika=pygame.transform.scale(pygame.image.load("Slike\\freezespecial.png"), (30,30)).convert_alpha()
            ...
            special=Novcic()
            specials.add(special)
            special.novcic_slika=pygame.transform.scale(pygame.image.load("Slike\\povecanjespecial.png"), (30,30)).convert_alpha()
            ...
            special=Novcic()
            specials.add(special)
            special.novcic_slika=pygame.transform.scale(pygame.image.load("Slike\\smanjenjespecial.png"), (30, 30)).convert_alpha()
            ...
            special=Novcic()
            specials.add(special)
            special.novcic_slika=pygame.transform.scale(pygame.image.load("Slike\\speedspecial.png"), (30, 30)).convert_alpha()
